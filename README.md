...
Visualiza el resultado y descárgalo como cv.html.
...
El usuario ingresa los datos mediante Streamlit.

app.py genera el prompt del sistema (SYSTEM_PROMPT) con reglas estrictas sobre estructura y estilo.

openai_client.py convierte los archivos subidos en objetos adecuados (input_image o input_file) y los envía junto al texto al modelo seleccionado.

El modelo devuelve un HTML completo que se renderiza directamente en la app y puede descargarse.
